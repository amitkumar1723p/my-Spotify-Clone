...
allmusicplay_btn.addEventListener('click', function () {
    if (default_audio.paused || default_audio.currentTime == 0) {
        ...
        console.log('if condition', index_value)
        ...
        gif.style.opacity = 0
        console.log('else condition', index_value)
...
setInterval(() => {
    ...
    if(default_audio.paused&&default_audio.duration==default_audio.currentTime){
        console.log('paused')
        ...
        // if(index_value==11||index_value>=11){
        ...
        // else{
        //     console.log(' first else else condition')
            
                  
        // }

//         music-timmer-minutes
